 ...
 * of calls recorded as failure that will trigger the circuit breaker to transition to the [OPEN] state if equalled or exceeded.
 ...
 * @param recordExceptionPredicate a predicate that determines whether an exception should be recorded as a failure,
 * and as such, increase the failure rate.
 * @param recordSuccessAsFailurePredicate a predicate that determines whether a result of a successful operation should be recorded as a failure,
 * and as such, increase the failure rate.
 */
